package com.blogverse.unified.config;
...
/**
 * High-priority unified security configuration for the cloud single-JVM runner.
 * Centralizes CORS, permits public endpoints, and prevents 302 redirects.
 */
@Configuration
@EnableWebSecurity
