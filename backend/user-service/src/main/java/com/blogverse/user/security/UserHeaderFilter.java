package com.blogverse.user.security;
...
/**
 * Filter that reads X-User-Id, X-User-Email, X-User-Role, and X-User-Name
 * headers set by API Gateway and establishes Spring Security context.
 */
@Slf4j
@Component
